...
INSERT INTO courses (code, name, description, syllabus, prerequisites, registration_details)
VALUES
('SDEV140', 'Introduction to Programming', 'Introduction to programming using Python.', 'Syllabus content here', 'None', 'Register at the beginning of the semester.'),
('NETI101', 'Fundamentals of Networking', 'Fundamentals of computer networking.', 'Syllabus content here', 'Basic Computer Knowledge', 'Register at the beginning of the semester.');
